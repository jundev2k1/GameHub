...
{
    public async Task<AsymmetricKey> GetByCompositeKeyAsync(string name, AsymmetricKeyType keyType, string algorithm, CancellationToken ct = default)
    {
        var result = await context.AsymmetricKeys
            .AsNoTracking()
