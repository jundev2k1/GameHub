...
namespace game_x.persistence.Migrations
{
    ...
    [Migration("20260116073250_UpdateTransactionInternalTransfer")]
    partial class UpdateTransactionInternalTransfer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("game_x.domain.Entities.TransactionInternal", b =>
                {
                    ...
                    b.HasIndex("ReceiverId")
                        .HasDatabaseName("ix_transactions_internal_receiver_id");

                    b.HasIndex("TransferorId")
                        .HasDatabaseName("ix_transactions_internal_transferor_id");
            ...
            modelBuilder.Entity("game_x.domain.Entities.TransactionInternal", b =>
                {
                    ...
                    b.HasOne("game_x.domain.Entities.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .HasConstraintName("fk_transactions_internal_asp_net_users_receiver_id");

                    b.HasOne("game_x.domain.Entities.User", "Transferor")
                        .WithMany()
                        .HasForeignKey("TransferorId")
                        .HasConstraintName("fk_transactions_internal_asp_net_users_transferor_id");
