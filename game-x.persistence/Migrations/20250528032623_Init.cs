    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsymmetricKey", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPassport", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPassport_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AsymmetricKey_Name_KeyType_Algorithm",
                table: "AsymmetricKey",
                columns: new[] { "Name", "KeyType", "Algorithm" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserPassport_AppUserId",
                table: "UserPassport",
                column: "AppUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserPassport_PassportNumber",
                table: "UserPassport",
