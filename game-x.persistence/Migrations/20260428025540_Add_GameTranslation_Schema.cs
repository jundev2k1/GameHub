...
{
    /// <inheritdoc />
    public partial class Add_GameTranslation_Schema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_game_translations", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_game_translations_game_id_language_code",
                table: "game_translations",
                columns: new[] { "game_id", "language_code" },
                unique: true);
        }
