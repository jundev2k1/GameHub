...
public sealed class UpdateGamePlatformTranslationsValidator : AbstractValidator<UpdateGamePlatformTranslationsCommand>
{
    public UpdateGamePlatformTranslationsValidator()
    {
