...
public sealed class UpdateGameTranslationsValidator : AbstractValidator<UpdateGameTranslationsCommand>
{
    public UpdateGameTranslationsValidator()
    {
...
public class GameTranslationValidator : AbstractValidator<GameTranslationItem>
{
