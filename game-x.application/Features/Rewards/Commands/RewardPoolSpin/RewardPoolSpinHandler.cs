...
public sealed class SpinRewardHandler(
    ...
    ILogger<SpinRewardHandler> logger
) : ICommandHandler<RewardPoolSpinCommand, SpinRewardResponse>
{
    public async Task<SpinRewardResponse> Handle(
        RewardPoolSpinCommand request,
        CancellationToken ct = default)
    {
        ...
        var increasedItem = poolItem.RewardDefinition.CatalogItemId != null ? 
            ...
            : null;
        SpinRewardResponse response = null!;
        ...
        await unitOfWork.WithTransactionAsync(async () =>
        {
            try
            {
                ...
                response = new SpinRewardResponse
                {
    ...
    private async Task<(RewardPool rewardPool, RewardPoolItemDto[]? rewardItems)> 
        Validate(string userId, RewardPoolSpinCommand request, CancellationToken ct = default)
    {
