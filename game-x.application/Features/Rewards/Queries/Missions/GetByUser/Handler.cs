...
public sealed class GetMissionDetailByUserHandler(
    ...
    IMissionRepo repo,
    IFileManagerCacheService storage) : IQueryHandler<GetMissionDetailByUserQuery, MissionDetailDto>
{
    public async Task<MissionDetailDto> Handle(GetMissionDetailByUserQuery request, CancellationToken ct = default)
    {
