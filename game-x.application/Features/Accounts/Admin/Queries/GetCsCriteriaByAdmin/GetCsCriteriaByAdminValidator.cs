...
public sealed class GetCsCriteriaByAdminValidator : AbstractValidator<GetCsCriteriaByAdminQuery>
{
    ...
    public GetCsCriteriaByAdminValidator()
    {
    ...
    private void ValidateFilterField(QueryFilter filter, ValidationContext<GetCsCriteriaByAdminQuery> context)
    {
    ...
    private void ValidateSortField(QuerySort sort, ValidationContext<GetCsCriteriaByAdminQuery> context)
    {
