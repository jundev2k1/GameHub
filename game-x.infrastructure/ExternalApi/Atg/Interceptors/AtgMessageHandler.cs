...
public sealed class AtgMessageHandler(IOptions<Etl998Settings> settings): DelegatingHandler
{
    protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken ct)
    {
        ...
        var data = AtgSecurity.DesEncryptToBase64(json, settings.Value.DesKey);
        var sign = AtgSecurity.ComputeSignProvider(data);
